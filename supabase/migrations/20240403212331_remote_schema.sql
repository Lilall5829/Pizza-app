...
CREATE POLICY "All operation to all authenticated users" ON "public"."order_items" TO "authenticated" USING (true);

CREATE POLICY "All operations to all users" ON "public"."orders" TO "authenticated" USING (true);
